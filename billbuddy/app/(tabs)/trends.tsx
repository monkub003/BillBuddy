    ...
    <View style={insightStyles.card}>
      <View style={insightStyles.header}>
        ...
        <View style={insightStyles.textContainer}>
          <View style={[insightStyles.typeBadge, { backgroundColor: barColor + "22" }]}>
            <Text style={[insightStyles.typeLabel, { color: barColor }]}>
              {typeLabelMap[insight.type] || insight.type}
            </Text>
          </View>
  ...
  return (
    ...
    >
      ...
      <View style={screenStyles.monthNav}>
        <TouchableOpacity onPress={goToPrevMonth} style={screenStyles.monthNavBtn}>
          <Text style={screenStyles.monthNavArrow}>‹</Text>
        </TouchableOpacity>
        <Text style={screenStyles.monthNavLabel}>
          {FULL_THAI_MONTHS[selectedMonth - 1]} {selectedYear + 543}
        </Text>
        <TouchableOpacity onPress={goToNextMonth} style={screenStyles.monthNavBtn}>
          <Text style={screenStyles.monthNavArrow}>›</Text>
        </TouchableOpacity>
      </View>
      ...
      {loading && insights.length === 0 && (
        <View style={screenStyles.chartCard}>
          <ActivityIndicator size="small" color={Theme.accent.green} />
          <Text style={{ color: Theme.text.secondary, textAlign: "center", marginTop: 8, fontSize: 13 }}>
      ...
      {!loading && insights.length === 0 && (
        <View style={screenStyles.chartCard}>
          <Text style={{ color: Theme.text.secondary, textAlign: "center", fontSize: 13 }}>
            ยังไม่มี AI Insights — เพิ่มค่าใช้จ่ายเพื่อรับคำแนะนำ
          </Text>
        </View>
      )}
